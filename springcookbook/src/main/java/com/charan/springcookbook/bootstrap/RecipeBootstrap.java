package com.charan.springcookbook.bootstrap;

import com.charan.springcookbook.domain.*;
import com.charan.springcookbook.repositories.CategoryRepository;
import com.charan.springcookbook.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        UnitOfMeasure teasSpoonUom = teaSpoonUomOptional.get();
        ...
        guacRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teasSpoonUom, guacRecipe));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Dried Oregano", new BigDecimal(1), teasSpoonUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Dried Cumin", new BigDecimal(1), teasSpoonUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Sugar", new BigDecimal(1), teasSpoonUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Salt", new BigDecimal(".5"), teasSpoonUom, tacosRecipe));
